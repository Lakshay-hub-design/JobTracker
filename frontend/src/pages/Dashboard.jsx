...
const JobItem = React.memo(function JobItem({ job }) {
  ...
  return (
    <motion.div
      ...
      className="cursor-pointer hover:shadow-lg bg-gray-50 border rounded-lg p-4 shadow-sm flex flex-col gap-2"
    >
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white shadow-md rounded-lg p-4 mb-6 gap-4"
      >
