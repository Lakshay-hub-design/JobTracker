...
export default function AddJob({ onClose, onJobAdded }) {
  ...
  const [form, setForm] = useState({
    company: '', position: '', status: 'applied', location: "", jobType: 'full-time', notes: '', description: '', resumeUrl: ""
  });
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-xl p-6 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <input type="text" name="resumeUrl" placeholder="Resume Link"
          ...
          <button className="w-full bg-yellow-300 text-black py-2 rounded">Add Job</button>
        </form>
      </div>
    </div>
  );
