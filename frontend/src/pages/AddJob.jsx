      ...
      <div className="relative w-full max-w-xl p-6 bg-white rounded-lg shadow-lg dark:bg-[#232b2b] dark:text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-black/50 dark:bg-[#232b2b] dark:text-white">Follow-up Date</label>
            <input
              type="date"
              name="followUpDate"
              value={form.followUpDate || ""}
              onChange={handleChange}
              className="p-2 rounded border border text-black/50 dark:bg-[#232b2b] dark:text-white"
            />
          </div>
          <input
            type="text"
